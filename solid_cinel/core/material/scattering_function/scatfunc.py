...
from solid_cinel.core.material.scattering_function.clm import get_scat_sct_angular, get_ScatFunc_pdos_angle, scat_from_pdos, sigma1
...
class ScatFuncSD:
    ...
    def data(self, pdf: Iterable):
        ...
        pdf_ = pdf_[~pdf_.index.duplicated(keep='first')]
    ...
    def from_SabSD(cls, Ein: float, M: float, T: float, Eout: np.array,
        ...
        if model.lower() == "pdos":
            ...
            tau1 = args[-1].get_tau_1(T).values
