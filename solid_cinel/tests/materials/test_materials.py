...
class Fe56Test(SolidTestBase):
    def setUp(self) -> None:
        self.solid_name = 'Fe56'
        self.T = [20, 80, 293.6, 400, 600, 800]
        rho_in_energy_str = '''
            ...
            '''
        self.rho_in_energy = np.fromstring(rho_in_energy_str, dtype=np.float64, sep=' ')
        self.interv_in_energy = 0.0005
        self.energy_cut = 4.096
        self.energy_sup = 10.0
        alpha0_str = '''
...
class UO2Test(Be9Test):
    def setUp(self) -> None:
        ...
        rho_in_energy_O16 = np.fromstring(rho_in_energy_O16_str,
                                          dtype=np.float64,
                                          sep=' ')
        interv_in_energy = 6.956193E-04
        ...
        '''
        rho_in_energy_U238 = np.fromstring(rho_in_energy_U238_str,
                                           dtype=np.float64,
                                           sep=' ')
        pdosUO2 = {"O16": Pdos.from_dE(rho_in_energy_O16, interv_in_energy),
                   "U238": Pdos.from_dE(rho_in_energy_U238, interv_in_energy)}
        self.solid.set_pdos(pdosUO2)
